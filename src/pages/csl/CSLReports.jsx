...
export default function CSLReports() {
  const { user } = useAuth()
  ...
  const loadReportData = async () => {
    try {
      ...
      const [policies, interactions] = await Promise.all([
        ...
        cslService.interaction.getInteractionsByAgent(user.id)
      ])
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Track your performance and activity</p>
      </div>
